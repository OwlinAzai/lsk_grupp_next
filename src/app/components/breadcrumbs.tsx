...
export default function Breadcrumbs() {
  ...
  return (
    <div className="breadcrumbs-container ml-[14rem] mr-[14rem] inline-block mt-4 pb-4 relative">
      <div className="breadcrumbs-wrapper h-12 shadow-xl justify-center items-center flex rounded-lg px-4 bg-white">
        <ul className="breadcrumbs flex items-center text-xl">
          ...
          <span className="breadcrumb-separator align-middle">{"▶"}</span>
          ...
          {BreadcrumbsArray.map((item, index) => {
            ...
            return (
              <li key={index} className="mr relative">
                <Link
                  className="hover:text-orange-400 font-regular"
